...
<g id="green" fill="${P.green}" fill-opacity="0.9"><path d="${greenD}"/></g>
<path id="toronto-outline" d="${boundaryD}" fill="none" stroke="${P.ink}" stroke-width="2" stroke-linejoin="round"/>
</svg>`;
